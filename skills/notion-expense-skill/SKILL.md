...
1. **Распарсить** команду вручную / вопросами:
   ...
   - `account` (куда зачисляем; по умолчанию “Наличные”; варианты: “Виртуальная карта тг”, “Беларусбанк”, “Накопление монет”…).
   - `transfer_account` (откуда переводили) — спрашивай, если пользователь говорит “перевёл/перебросил со счёта X на Y”.
